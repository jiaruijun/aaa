...
public class HttpRequestUtil {
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param, boolean isproxy,String method) {
        ...
        try {
            ...
            conn.setRequestMethod(method); // POST方法
            ...
            conn.setRequestProperty("Powerkey", "m722s566b872o629");
    ...
    public static boolean httpPostWithJson(JSONObject jsonObj,String url,String appId){
        ...
        try {
         ...
         //   String sessionId = getSessionId();
            post.setHeader("SessionId", "111");
            post.setHeader("appid", "111");
